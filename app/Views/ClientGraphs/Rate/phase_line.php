                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-bottom-dashed pb-0 mb-0">
                                <?= view('ClientGraphs/Rate/_tabs', ['tab' => 'phase-line']) ?>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title" id="add_modal_title">Add Rate Graphs Phase Line</h5>
    ...
    $(document).ready(function() {
        ...
        function show_add_modal() {
            ...
            if (client_id == '') {
                ...
                $("#add_modal_title").html('Add Rate Graphs Phase Line  [' + client_detail + ']');
        ...
        $('#btn_add').on('click', function() {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>graphs/rate/phase-line/new',
                type: 'post',
                data: data,
                beforeSend: function(xhr) {
        ...
        $("#phase_line_table").on('click', '.update', function(e) {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>graphs/rate/phase-line/get-selected',
                type: 'post',
                data: {
                    "id": id,
                    'graph_type': 'Target_Rate'
            ...
            ajaxRequest.done(function(response) {
                if (response.status == 'success') {
                    ...
                    $('#update_modal #update_modal_title').html('Update Rate Graphs Phase Line');
                    $("#u_week_date").flatpickr({
        ...
        $('#btn_update').on('click', function() {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>graphs/rate/phase-line/update',
                type: 'post',
                data: data,
                beforeSend: function(xhr) {
                    btn.prop("disabled", true);
        ...
        $("#phase_line_table").on('click', '.delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var ajaxRequest = $.ajax({
                        url: '<?php echo base_url() ?>graphs/rate/phase-line/delete',
                        type: 'post',
                        data: {
                            "id": id,
                            'graph_type': 'Target_Rate'
