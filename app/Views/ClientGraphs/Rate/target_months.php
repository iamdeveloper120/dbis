                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-bottom-dashed pb-0 mb-0">
                                <?= view('ClientGraphs/Rate/_tabs', ['tab' => 'target-months']) ?>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title" id="add_modal_title">Add Target Month</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control " name="a_target_date" id="a_target_date">
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="graph_type">Graph Type *</label>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control " name="u_target_date" id="u_target_date">
                    </div>
    ...
    $(document).ready(function() {
        ...
        function show_add_modal() {
            ...
            if (client_id == '') {
                ...
                $("#add_modal_title").html('Add Target Month [' + client_detail + ']');
        ...
        $('#btn_add').on('click', function() {
            ...
            var data = {
                't_date': $('#add_modal #a_target_date').val(),
                'client_id': $('#add_modal #client_id').val(),
                'graph_type': $('#add_modal #graph_type').val()

            };

            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>graphs/rate/target-months/new',
                type: 'post',
                data: data,
                beforeSend: function(xhr) {
        ...
        $('#add_modal').on('hidden.bs.modal', function(e) {
            ...
            $('#add_modal #a_target_date').val('');
            $('#add_modal #client_id').val('');
            $('#add_modal #graph_type').val('');

        });


        /**************************************************************************************** */
        $("#target_months_table").on('click', '.update', function(e) {
            var btn = $(this);
            var id = $(this).attr('id');
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>graphs/rate/target-months/get-selected',
                type: 'post',
                data: {
                    "id": id, 
                },
            ...
            ajaxRequest.done(function(response) {
                if (response.status == 'success') {
                    ...
                    $('#update_modal #update_modal_title').html('Update Target Month');
                    ...
                    $('#update_modal #graph_type').val(row_data.graph_type);
        ...
        $('#btn_update').on('click', function() {
            ...
            var data = {
                ...
                't_date': $('#update_modal #u_target_date').val(),
                'graph_type': $('#update_modal #graph_type').val()
            };
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>graphs/rate/target-months/update',
                type: 'post',
                data: data,
                beforeSend: function(xhr) {
                    btn.prop("disabled", true);
        ...
        $('#update_modal').on('hidden.bs.modal', function(e) {
            ...
            $('#update_modal #u_target_date').val('');
            $('#update_modal #client_id').val('');
            $('#update_modal #graph_type').val('');
            $('#update_modal #id').val('');

        });

        /*************************************************************************************** */
        $("#target_months_table").on('click', '.delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var ajaxRequest = $.ajax({
                        url: '<?php echo base_url() ?>graphs/rate/target-months/delete',
                        type: 'post',
                        data: {
                            "id": id, 
                        },
