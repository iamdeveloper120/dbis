            ...
            <div class="col-lg-12">
                <div class="card mt-n4 mx-n4" style="border-radius:0px">
                    <div class="bg-soft-info alert-info alert-top-border">
                        ...
                        <div class="dev_prog_main_bg" id='target_table'>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex justify-content-between align-items-center" style="padding-left: 20px; padding-right: 20px;">
                                            ...
                                            <button
                                                ...
                                                onclick="openMandsHelpModal('prompt_level', 'mandsHelpModalReviewEntry', 'mandsHelpTemplatesReviewEntry')"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="d-flex align-items-center justify-content-between" style="padding-left: 20px; padding-right: 20px;">
                                        <strong>Vocal Response</strong>
                                        <button
                                            type="button"
                                            class="btn btn-link p-0 text-info"
                                            onclick="openMandsHelpModal('vocal_response_box', 'mandsHelpModalReviewEntry', 'mandsHelpTemplatesReviewEntry')"
                                ...
                                <div class="col-sm-12">
                                    <div class="d-flex align-items-center justify-content-between" style="padding-left: 20px; padding-right: 20px;">
                                        ...
                                        <button
                                            type="button"
                                            class="btn btn-link p-0 text-info"
                                            onclick="openMandsHelpModal('echoic', 'mandsHelpModalReviewEntry', 'mandsHelpTemplatesReviewEntry')"
                            ...
                            <div class="alert alert-light alert-top-border fade show material-shadow" role="alert">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="<?= base_url('/sessions/review/' . $session_id . '/mands') ?>" data-client-id="<?= $client_id; ?>" class="btn btn-primary"><i class="ri-arrow-left-line p-1 align-middle"></i>Back to mands review</a>
                                    </div>
                                    <div class="col-md-6 text-end">
                                        <a href="#" data-client-id="<?= $client_id; ?>" data-session-id="<?= $session_id; ?>" class="btn btn-primary save-button " id="save_mands"><i class="ri-save-line p-1 align-middle"></i>Save</a>
                                    </div>
                                </div>
                            </div>
...
<?= view('ClientSessions/Mands/_help_templates', ['template_container_id' => 'mandsHelpTemplatesReviewEntry']) ?>
<?= view('ClientSessions/Mands/_help_modal', ['modal_id' => 'mandsHelpModalReviewEntry']) ?>
<?= $this->endSection() ?>
    ...
    $(document).ready(function() {
        ...
        $("#save_mands").on('click', function(event) {
            ...
            var ajaxRequest = $.ajax({
                type: 'POST',
                url: '<?= site_url('sessions/review/mands/save') ?>',
                data: {
                    "client_id": client_id,
