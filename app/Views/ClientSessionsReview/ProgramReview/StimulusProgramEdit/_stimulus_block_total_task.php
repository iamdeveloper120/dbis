...
$prefillMap = $target['prefill_step_inputs'][$phaseId]['total_task'] ?? [];
?>

<div id="total-task-content-<?= $targetId ?>" class="table-responsive mb-3">
...
<div class="text-end">
    <button class="btn btn-primary save-stimulus-button"
        ...
        data-method="total_task">
        <i class="ri-save-line me-1"></i> Save Total Task
    </button>
</div>