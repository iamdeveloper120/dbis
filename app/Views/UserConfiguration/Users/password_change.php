<form action="/user-configuration/users/edit/<?= $user->id ?>/changePassword" method="post">
    ...
    <div class="row mb-2">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="password" id="password" autocomplete="password" placeholder="<?= lang('Auth.password') ?>" onkeyup="checkStrength()" required />
            </div>
        </div>
        <!-- Password Meter -->
    ...
    <div class="row mb-5">
        <div class="col">
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="pass_confirm" id="pass_confirm" autocomplete="pass_confirm" placeholder="<?= lang('Auth.passwordConfirm') ?>" required onkeyup="checkPasswordMatch()" />
            </div>
        </div>
