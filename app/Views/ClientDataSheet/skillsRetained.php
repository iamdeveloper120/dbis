...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            <li class="breadcrumb-item active">Skills Retained</li>
        </ol>
    </div>
</div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-header pb-0 mb-0">
                                <?= view('ClientDataSheet/_tabs', ['tab' => 'skillsTab']) ?>
                            </div>
                            <div class="card-body border-bottom-dashed border-bottom">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="width: 100%;" id="skills_retained_data_table">
                                        <thead>
                                            <tr>
...
<script>
    $(document).ready(function() {
        ...
        var skillsRetainedTable = $('#skills_retained_data_table').DataTable({
            responsive: false,
            ordering: false,
            lengthChange: false,
            ajax: {
                url: '<?= base_url('dataSheet/filterSkillsRetained') ?>',
                type: 'POST',
                data: function(d) {
        ...
        $('#filter_data').on('click', function() {
            skillsRetainedTable.ajax.reload(); // This will reload the table based on the filters
        });
    });
</script>
<?= $this->endSection() ?>