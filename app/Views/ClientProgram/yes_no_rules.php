<div class="card border card-border-primary mb-3">
    <div class="card-header">
        <h5 class="card-title"> Yes/No Probes Rules for Selected Combination</h5>
    </div>
    <div class="card-body">
                    ...
                    <?php foreach ($rules as $rule) : ?>
                        ...
                        <?php if ($phaseId == 1 || $phaseId == 3 || $phaseId == 4) : ?>
                            <tr>
                                ...
                                <td><?= esc($rule['json_rules']['frame_check'] ? 'Yes' : '') ?></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <div class="form-check form-switch form-switch-lg" style="padding-left: 10px !important;">
                                        <input class="form-check-input" type="checkbox" role="switch" name="frame_check_<?= $phaseId ?>" <?= isset($rule['json_rules']['frame_check']) && $rule['json_rules']['frame_check'] ? 'checked' : '' ?>>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check form-switch form-switch-lg" style="padding-left: 10px !important;">
