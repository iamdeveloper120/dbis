                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-bottom-dashed pb-0 mb-0">
                                <?= view('ClientProgram/_tabs', ['tab' => 'domains', 'client_id' => $encodedClientId]) ?>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: '<?php echo base_url() ?>client-program/domains/list',
            type: 'post',
            data: {
                'client_id': <?= $client->id ?>
            },
        ...
        $('#btn_add').on('click', function() {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>client-program/domains/create',
                type: 'post',
                data: data,
        ...
        $("#dataTable").on('click', '.update', function(e) {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>/client-program/domains/single',
                type: 'post',
                data: {
                    "id": id,
                },
        ...
        $('#btn_update').on('click', function() {
            ...
            //console.log(data);
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>client-program/domains/update',
                type: 'post',
                data: data,
                beforeSend: function(xhr) {
                    btn.prop("disabled", true);
        ...
        $("#dataTable").on('click', '.delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var ajaxRequest = $.ajax({
                        url: '<?php echo base_url() ?>client-program/domains/delete',
                        type: 'post',
                        data: {
                            "id": id,
                        },
