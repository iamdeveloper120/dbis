...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    <h5 class="mb-sm-0">Select a client to views profile</h5>
                                ...
                                <tr>
                                    ...
                                    <td style="width:110px">
                                        <a href="<?= base_url('client-profile/dashboard/' . encodeValue($client->id)) ?>"
                                            class="btn btn-sm btn-light btn-label waves-effect waves-light">
                                            <i class="ri-user-smile-line label-icon align-middle fs-16 me-2"></i>View Profile
                                        </a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
