                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-bottom-dashed pb-0 mb-0">
                                ...
                                <?= view('MasterProgram/_tabs', ['tab' => 'goals']) ?>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#btn_add').on('click', function() {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>master-program/goals/create',
                type: 'post',
                data: data,
                beforeSend: function(xhr) {
        ...
        $("#dataTable").on('click', '.update', function(e) {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>master-program/goals/single',
                type: 'post',
                data: {
                    "id": id,
                },
        ...
        $('#btn_update').on('click', function() {
            ...
            //console.log(data);
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>master-program/goals/update',
                type: 'post',
                data: data,
                beforeSend: function(xhr) {
                    btn.prop("disabled", true);
        ...
        $("#dataTable").on('click', '.delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var ajaxRequest = $.ajax({
                        url: '<?php echo base_url() ?>master-program/goals/delete',
                        type: 'post',
                        data: {
                            "id": id,
                        },
