                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-bottom-dashed pb-0 mb-0">
                                ...
                                <?= view('MasterProgram/_tabs', ['tab' => 'targets']) ?>
                            </div>
    ...
    $(document).ready(function() {
        ...
        $("#domains_dropdown_list").on('change', function(e) {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>master-program/goals/list',
                type: 'post',
                data: {
                    "domain_id": domain_id,
                },
        ...
        $("#goals_dropdown_list").on('change', function(e) {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>master-program/targets/list',
                type: 'post',
                data: {
                    "goal_id": goal_id,
                },
        ...
        $('#btn_add').on('click', function() {
            ...
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>master-program/targets/create',
                type: 'post',
                data: data,
                beforeSend: function(xhr) {
        ...
        $("#dataTable").on('click', '.update', function(e) {
            ...
            if (domain_id == '' || goal_id == '') {
                ...
                let goal_detail = $("#goals_dropdown_list :selected").html();
                var ajaxRequest = $.ajax({
                    url: '<?php echo base_url() ?>master-program/targets/single',
                    type: 'post',
                    data: {
                        "id": id,
                    },
        ...
        $('#btn_update').on('click', function() {
            ...
            //console.log(data);
            var ajaxRequest = $.ajax({
                url: '<?php echo base_url() ?>master-program/targets/update',
                type: 'post',
                data: data,
                beforeSend: function(xhr) {
                    btn.prop("disabled", true);
        ...
        $("#dataTable").on('click', '.delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var ajaxRequest = $.ajax({
                        url: '<?php echo base_url() ?>master-program/targets/delete',
                        type: 'post',
                        data: {
                            "id": id,
                        },
