...
use App\Entities\ClientSessions\SessionMandDuration;


class SessionMandDurationModel extends Model
{
    protected $DBGroup          = 'default';
    protected $table            = 'daily_sessions_mands_duration';
    protected $primaryKey       = 'id';
    protected $useAutoIncrement = true;
    protected $returnType       = SessionMandDuration::class;
    ...
    public function getMandDuration($session_id)
    {
    ...
    /**
     * Check if given start and end time overlaps with existing mands durations
     */
    public function hasOverlap($session_id, $start_time, $end_time, $exclude_id = null)
    {
        ...
        foreach ($existingDurations as $duration) {
            ...
            if ($startTime < $existingEnd && $endTime > $existingStart) {
                return [
                    'status' => false,
                    'message' => "The entered duration overlaps with an existing mands record ({$duration->start_time} - {$duration->end_time})."
                ];
            }
        }
