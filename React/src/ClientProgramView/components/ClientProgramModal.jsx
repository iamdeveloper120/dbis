...
const ClientProgramModal = ({ clientId,modalData, onClose, onComplete }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const requestData = {
        ...
        client_id: clientId, // Automatically included in formatData
...
export default ClientProgramModal;
